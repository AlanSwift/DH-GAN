...
class RNNDecoderImage(nn.Module):
    ...
    def forward(self, img_feats, answer_hint, question=None, sampling=False):
    ...
    def _decode_step(self, dec_input_emb, rnn_state, image_feats, image_pool, answer_hint):
